        ...
        <div className="relative z-10 mx-auto px-6 py-20 max-w-6xl space-y-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-2xl border border-cyan-200/40 bg-white/25 backdrop-blur-md shadow hover:shadow-xl transition-transform hover:-translate-y-2 text-left text-raise"
              >
                <h3 className="text-xl font-semibold text-white drop-shadow mb-2">
                  {card.title}
                </h3>
                <p className="text-gray-100/90">{card.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mt-6">
            <div className="p-6 rounded-2xl border border-cyan-200/40 bg-white/20 backdrop-blur-md shadow text-left text-raise">
              <h2 className="text-3xl font-bold text-white drop-shadow mb-4">Vision</h2>
            ...
            <div className="p-6 rounded-2xl border border-cyan-200/40 bg-white/20 backdrop-blur-md shadow text-left text-raise">
              <h2 className="text-3xl font-bold text-white drop-shadow mb-4">Mission</h2>
              <ul className="list-disc pl-5 text-gray-100/90 space-y-3">
